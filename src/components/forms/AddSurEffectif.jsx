...
import {
  convDateFrancaiseEnISO,
  normalizeString,
  getSQLDatetime,
} from "../../utils/utils";

export function AddSurEffectif({
  dataSurEff,
  setDataAPI,
  setLoad,
}) {
  ...
  const handleSubmit = (event) => {
    ...
    const substanceDejaSignalee = dataSurEff.some(
      (item) =>
        normalizeString(item.substance.toLowerCase()) ===
        normalizeString(event.target.substance.value.trim().toLowerCase())
    );
